namespace Calculator
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Click += new System.EventHandler(this.button_Num);
			// 
			// button3
			// 
			...
			this.button3.Click += new System.EventHandler(this.button_Num);
			// 
			// button0
			// 
			...
			this.buttonEqu.Click += new System.EventHandler(this.Button_Op);
			// 
			// buttonMult
			// 
			...
			this.buttonMult.Click += new System.EventHandler(this.Button_Op);
			// 
			// buttonDiv
			// 
			...
			this.buttonDiv.Click += new System.EventHandler(this.Button_Op);
			// 
			// buttonAdd
			// 
			...
			this.buttonAdd.Click += new System.EventHandler(this.Button_Op);
			// 
			// buttonSub
			// 
			...
			this.buttonSub.Click += new System.EventHandler(this.Button_Op);
			// 
			// screen
			// 
			...
			this.screen.Size = new System.Drawing.Size(166, 30);
			...
			this.button10.Click += new System.EventHandler(this.Button_Op);
			// 
			// Form1
			// 
